				...
				<div className="container mx-auto px-4 md:px-8 relative z-10 text-center max-w-3xl">
					...
					<FadeIn delay={0.2}>
						<p className="text-xl text-zinc-400 leading-relaxed max-w-2xl mx-auto">
							Whether you need a consultation, have a project in mind, or want
							to explore our solutions, our team is ready to assist you.
						</p>
					</FadeIn>
				</div>
			</section>
									...
									<div className="flex items-start gap-4">
										...
										<div>
											...
											<a
												...
												className="text-zinc-600 hover:text-cyan-600 transition-colors font-medium"
											>
												+234 706 326 7111
											</a>
										</div>
								...
								{submitted ? (
									<div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center space-y-6">
										...
										<p className="text-lg text-zinc-500 font-medium max-w-sm mx-auto">
											Thank you for reaching out to ATOM TechServe. A member of
											our team will get back to you shortly.
										</p>
										<Button
											onClick={() => setSubmitted(false)}
											variant="outline"
											className="mt-8 rounded-full h-12 px-8 border-zinc-200 text-zinc-900 hover:bg-zinc-100"
										>
									...
									<form onSubmit={handleSubmit} className="space-y-6">
										...
										<Button
											type="submit"
											className="w-full h-14 text-base font-bold bg-zinc-900 text-white hover:bg-zinc-800 rounded-xl mt-4"
