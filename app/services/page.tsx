...
import { Database, LineChart, Smartphone, Cloud, Search, ShieldCheck, Laptop, Check } from "lucide-react";
...
const services = [
  {
    ...
    benefits: ["Centralized data management", "Real-time monitoring", "Improved reporting and decision-making"],
  ...
  },
  {
    ...
    benefits: ["Real-time analytics", "Easy KPI tracking", "Better strategic decisions"],
  ...
  },
  {
    ...
    benefits: ["Improved customer experience", "Increased accessibility", "Streamlined operations"],
  ...
  },
  {
    ...
    benefits: ["Process automation", "Increased productivity", "Scalable infrastructure"],
  ...
  },
  {
    ...
    benefits: ["Measurable impact tracking", "Data-driven improvements", "Continuous learning systems"],
  ...
  },
  {
    ...
    benefits: ["Simplified procurement", "Cost efficiency", "Compliance and updates"],
  ...
  },
  {
    ...
    benefits: ["Reliable equipment", "Improved productivity", "Access to trusted brands"],
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center max-w-3xl">
          ...
          <FadeIn delay={0.2}>
            <p className="text-xl text-zinc-400 leading-relaxed max-w-2xl mx-auto">
              Comprehensive software engineering, data systems, and IT solutions tailored to scale your organization.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          {services.map((service, index) => {
            ...
            return (
              <div key={service.id} id={service.id} className="scroll-mt-32">
                <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-16 md:gap-24 items-center`}>
                  <FadeIn direction={isEven ? "right" : "left"} className="w-full lg:w-1/2">
                    <div className="space-y-8">
                      <div className={`w-14 h-14 rounded-full ${service.bg} flex items-center justify-center mb-6`}>
                        {service.icon}
                      </div>
                      ...
                      <div className="space-y-6 pt-4">
                        <div>
                          <h3 className="text-sm font-bold text-zinc-900 uppercase tracking-wider mb-2">What it is</h3>
                          <p className="text-lg text-zinc-600 leading-relaxed">{service.what}</p>
                        </div>
                        <div>
                          <h3 className="text-sm font-bold text-zinc-900 uppercase tracking-wider mb-2">Who it’s for</h3>
                          <p className="text-lg text-zinc-600 leading-relaxed">{service.who}</p>
                        </div>
                      </div>
                      ...
                      <div className="pt-2">
                        <h3 className="text-sm font-bold text-zinc-900 uppercase tracking-wider mb-2">Tools Used</h3>
                      ...
                      <div className="pt-6">
                        <Button className="bg-zinc-900 text-white hover:bg-zinc-800 rounded-full h-12 px-8 text-sm font-medium" asChild>
                  ...
                  <FadeIn direction={isEven ? "left" : "right"} className="w-full lg:w-1/2">
                    <div className="relative h-[400px] lg:h-[600px] rounded-[2rem] overflow-hidden bg-zinc-50 flex items-center justify-center border border-zinc-100">
                      <div className="text-zinc-400 font-medium text-center px-4">
                        <div className="mb-4 flex justify-center opacity-50 grayscale">{service.icon}</div>
          ...
          <div className="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto">
            ...
            <FadeIn delay={0.2}>
              <p className="text-lg text-zinc-400 max-w-2xl mx-auto">
                Reach out to our experts for a personalized consultation tailored to your organizational needs.
              </p>
            </FadeIn>
            <FadeIn delay={0.4}>
              <Button className="bg-white text-zinc-950 hover:bg-zinc-200 rounded-full h-14 px-8 text-base font-medium mt-4" asChild>
